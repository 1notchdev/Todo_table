...
;(function ($, window, document, undefined) {
	...
	jq1101(window).on('mousemove.tooltipster', function() {
		touchDevice = false;
		jq1101(window).off('mousemove.tooltipster');
	});
		...
		init: function() {
			...
			if (run) {
				...
				if ((object.options.touchDevices) && (touchDevice) && ((object.options.trigger == 'click') || (object.options.trigger == 'hover'))) {
					$this1.on('touchstart.tooltipster', function(element, options) {
						object.showTooltip();
					});
				}
				...
				// if this is a desktop, deal with adding regular mouse events
					...
					if (object.options.trigger == 'hover') {
						$this1.on('mouseenter.tooltipster', function() {
							object.showTooltip();
						});
						...
						// if this is a dumb tooltip, just get rid of it on mouseleave
							...
							$this1.on('mouseleave.tooltipster', function() {
								object.hideTooltip();
							});
						}
					}
    ...
    getContent: function(element) {
      ...
      content = $(jq1101.parseHTML('<div>' + content + '</div>')).html();
	...
	jq1101(window).on('scroll.tooltipster', function() {
	...
	jq1101(window).on('resize.tooltipster', function() {
		var origin = $('.tooltipster-base').data('origin');
